...
import me.limeglass.funky.utils.annotations.Single;

public abstract class FunkyExpression<T> extends SimpleExpression<T> implements DataChecker {
	...
	@SuppressWarnings("unchecked")
	public <V> Boolean isNull(Event event, Class<T>... types) {
